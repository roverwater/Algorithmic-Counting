...
class SequenceDataset(Dataset):
    def __init__(self):
        ...
        # Power‐law exponent (tune as hyperparameter; e.g. 1.5–2.5)
        alpha = 1.8

        # Precompute support {0,…,K} and their normalized weights
        ...
        for _ in range(self.batch_size):
            # Always use full length for simplicity
            seq_len = self.max_seq_len

            # 1) Sample number of special tokens (long tail)
            ...
            # 3) Mix them up and prepend special markers
